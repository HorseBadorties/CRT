...
public class Drive_Quickstart {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
        		Drive_Quickstart.class.getResourceAsStream("/client_secret.json");
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Find 'Repertoire' folder
        FileList repList = service.files().list()
	        .setQ("mimeType='application/vnd.google-apps.folder'")
	        .setQ("name='Repertoire'")	   	 	
